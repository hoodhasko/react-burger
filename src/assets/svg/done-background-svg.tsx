export const DoneBackgroundSVG = () => {
  return (
    <svg
      width="107"
      height="102"
    ...
    >
      <g clip-path="url(#clip0_84_4568)">
        <path
          ...
          fill="url(#paint0_radial_84_4568)"
          fill-opacity="0.25"
        />
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
          d="M103.944 39.453C108.019 46.5983 108.019 55.4017 103.944 62.547L88.5996 89.453C84.5247 96.5983 76.994 101 68.8442 101H38.1558C30.006 101 22.4753 96.5983 18.4004 89.453L3.05617 62.547C-1.01872 55.4017 -1.01872 46.5983 3.05617 39.453L18.4004 12.547C22.4753 5.40169 30.006 1 38.1558 1H68.8442C76.994 1 84.5247 5.40169 88.5996 12.547L103.944 39.453Z"
          fill="url(#paint1_radial_84_4568)"
          fill-opacity="0.25"
        />
        <path
          fill-rule="evenodd"
          ...
          fill="url(#paint2_radial_84_4568)"
          fill-opacity="0.25"
        />
      </g>
      <defs>
        <radialGradient
          id="paint0_radial_84_4568"
          cx="0"
          cy="0"
          r="1"
